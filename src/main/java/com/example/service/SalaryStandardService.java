...
public interface SalaryStandardService {
    ...
    // 新增薪酬标准
    void createSalaryStandard(SalaryStandard salaryStandard, String currentUser);

    // 查询薪酬标准，包括模糊查询
    List<List<SalaryStandard>> searchSalaryStandards(Integer salaryStandardID, String keyword, Date startTime, Date endTime);

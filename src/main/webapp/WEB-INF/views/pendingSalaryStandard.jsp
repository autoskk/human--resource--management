...
<form action="/salary-standards/edit" method="post">
  ...
  <input type="text" id="standardName" name="standardName" value="${salaryStandard.standardName}" readonly/>

  <label for="baseSalary">基本工资:</label>
  <input type="number" id="baseSalary" name="baseSalary" value="${salaryStandard.baseSalary}" step="0.01" readonly/>
  ...
  <input type="text" id="reviewComment" name="reviewComment" placeholder="请输入复核意见" value="${salaryStandard.reviewComment}" required />

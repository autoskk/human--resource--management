...
<body>
<div class="container">
  <a class="btn btn-secondary mb-4" href="${pageContext.request.contextPath}/employee/review"><i class="fas fa-arrow-left"></i> 返回</a>
  <h1 class="text-center">审核员工档案</h1>

  <%
    EmployeeRecord employeeRecord = (EmployeeRecord) request.getAttribute("employee");
  %>

  <form action="${pageContext.request.contextPath}/employee/review" method="post" enctype="multipart/form-data" class="p-4 bg-white">
    ...
    <input type="submit" value="提交审核" class="btn btn-custom mt-3"/>
  </form>
</div>
</body>
</html>
